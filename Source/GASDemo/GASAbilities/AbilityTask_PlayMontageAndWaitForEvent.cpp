...
#include "GASDemo/GASAbilities/AbilityTask_PlayMontageAndWaitForEvent.h"
...
void UAbilityTask_PlayMontageAndWaitForEvent::Activate()
{
	...
	if (GDAbilitySystemComponent)
	{
		...
		if (AnimInstance != nullptr)
		{
			...
			EventHandle = GDAbilitySystemComponent->AddGameplayEventTagContainerDelegate(EventTags, FGameplayEventTagMulticastDelegate::FDelegate::CreateUObject(this, &UAbilityTask_PlayMontageAndWaitForEvent::OnGameplayEvent));
...
UGDAbilitySystemComponent* UAbilityTask_PlayMontageAndWaitForEvent::GetTargetASC()
{
